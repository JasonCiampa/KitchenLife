...
public class TestCode extends ApplicationAdapter
{
	...
	public void create() {
            ...
            // create playerModel
            player = new GLTFLoader().load(Gdx.files.internal("TrainingBoothPlate.gltf"));
...
//            playerModel.animationController.setAnimation("ConeDog", -1);
...
//            camera.position.set(currentPosition.x, 0, currentPosition.z - camPitch);
